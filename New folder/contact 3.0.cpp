...
/*===============================================================================
DSA PROJECT:	Contact Book

PRESENTED TO:
				DR SOHAIL AKHTAR

PRESENTED BY: 	MUHAMMAD AHSAN ZAHOOR	(01-136212-023)
				AMNA FAROOQ				(01-136212-006)
				HUDA GIILANI			(01-136212-038)
				FIZZA KHAN AWAN         (01-136212-011)
...
void welcome()
{
		ifstream inth;
		string sth;
			inth.open("DSA.text", ios::in);
		if (!inth)
		{
			cout << "Exiting..." << endl;
			cout << "\t\t Thankyou for visiting us!! Have a nice day." << endl;
			exit(0);
		}
		else
		{
...
{   
	...
	SetConsoleTitle(_T("DSA CONTACT BOOK"));		//setting console title
system("color FC");	
